...
function HomePage(props) {
	...
	return (
		<div className="min-w-fit text-yellow-200 flex items-center -mt-10 relative z-index-0 min-h-screen px-2 bg-yellow-100 bg-[url('/src/assets/main-homepage-frame.png')] bg-cover bg-center bg-no-repeat">
			<div className="animate__animated animate__fadeIn container flex flex-col gap-5 items-center bg-yellow-900 bg-[url('/src/assets/circle-frame.png')] bg-center bg-no-repeat bg-cover border-8 border-yellow-200/75 rounded-md px-5 py-8 max-w-4xl md:mx-auto h-max my-24 text-center relative z-index-1">
