...
وَمِنْ آيَاتِهِ أَنْ خَلَقَ لَكُمْ مِنْ أَنْفُسِكُمْ أَزْوَاجًا لِتَسْكُنُوا إِلَيْهَا وَجَعَلَ بَيْنَكُمْ مَوَدَّةً وَرَحْمَةً ۚ إِنَّ فِي ذَٰلِكَ لَآيَاتٍ لِقَوْمٍ يَتَفَكَّرُونَ ﴿ ٢١﴾
			...
			<div className="animate__animated animate__fadeIn container flex flex-col py-5 flex-wrap gap-5 bg-amber-700 p-2 border-2 border-yellow-200 shadow-md rounded-md md:flex-nowrap max-w-4xl md:mx-auto h-max mb-32 text-center relative z-index-1 text-white">
