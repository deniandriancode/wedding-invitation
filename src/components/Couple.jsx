...
function Couple(props) {
	...
	return (
		<div className="min-w-fit flex flex-col box-border justify-center items-center -mt-10 relative z-index-0 h-max px-2 bg-yellow-100 bg-[url('/assets/main-homepage-frame.png')] bg-[url()] bg-cover bg-center bg-no-repeat">
			<div className="animate__animated animate__fadeIn container rounded-md flex flex-col gap-8 items-center box-border justify-center shadow-md border-2 border-yellow-700 max-w-xl md:mx-auto bg-yellow-50 h-max py-24 my-24 text-center relative z-index-1 px-2 md:px-8">
...
وَمِنْ آيَاتِهِ أَنْ خَلَقَ لَكُمْ مِنْ أَنْفُسِكُمْ أَزْوَاجًا لِتَسْكُنُوا إِلَيْهَا وَجَعَلَ بَيْنَكُمْ مَوَدَّةً وَرَحْمَةً ۚ إِنَّ فِي ذَٰلِكَ لَآيَاتٍ لِقَوْمٍ يَتَفَكَّرُونَ ﴿ ٢١﴾
			...
			<div className="animate__animated animate__fadeIn container flex flex-col py-5 flex-wrap gap-5 bg-amber-800 py-12 px-2 md:px-6 shadow-md rounded-md md:flex-nowrap max-w-4xl md:mx-auto h-max mb-32 text-center relative z-index-1 text-white">
                ...
                <div className="container flex flex-wrap md:flex-nowrap gap-2">
                    <AnimationOnScroll className="flex flex-col gap-3 items-center box-border justify-center w-full bg-[#613a12] rounded-md shadow-md border-2 border-yellow-200/75 px-5 md:px-15 py-5" animateIn="animate__bounceIn">
                    ...
                    <AnimationOnScroll className="flex flex-col gap-3 items-center box-border justify-center w-full bg-[#613a12] rounded-md shadow-md border-2 border-yellow-200/75 px-5 md:px-15 py-5" animateIn="animate__bounceIn">
                        ...
                        <h1 className="font-bold">Tiara Septian Mubarakah</h1>
