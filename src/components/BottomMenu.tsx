...
// bg-[#fedada]
/*
const bottomMenuBg = "bg-[#fedada]";
const bottomMenuBorderColor = "border-purple-200";
const bottomMenuTextColor = "text-purple-700";
const tabTextHoverColor = "hover:text-purple-700";
const tabBorderHoverColor = "hover:border-purple-400";
const tabActiveBorderColor = "border-purple-700";
const tabActiveTextColor = "text-purple-700";
*/
...
interface Props {
    tabs: TabType[];
    handleSetTab: HandleSetTabType;
}

function BottomMenu({ tabs, handleSetTab }): React.FC<Props> {
    ...
    const tabList = tabs.map((item, index) => {
        return (
            <li className="mr-2" key={index}>
                ...
                >
                    <span className="text-md md:text-lg inline-flex">{item.icon.map(ic => ic)}</span>
