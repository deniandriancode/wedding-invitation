...
function MainHomePage(props) {
	return (
		<div className="min-w-fit relative z-index-0 min-h-screen bg-[url('/src/assets/main-homepage-bg.jpg')] bg-cover bg-center bg-no-repeat bg-fixed px-2">
			<Overlay />
			<div className="container w-fit md:w-max bg-yellow-900/75 text-white flex flex-col items-center justify-center text-center px-2 md:px-24 relative w-auto h-screen z-index-1">
				...
				<a href="#" className="inline-flex items-center gap-2 bg-yellow-700 shadow-lg hover:bg-yellow-800 focus:ring focus:ring-yellow-700 px-5 py-2 rounded-md ease-in-out duration-200">
					<BsArrowRightCircle />
					Buka Undangan
				</a>
			</div>
