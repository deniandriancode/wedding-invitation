...
function MainHomePage(props) {
	return (
		<div className="min-w-fit relative box-border py-12 z-index-0 min-h-screen px-2 bg-gradient-to-b from-amber-800 to-amber-900 bg-[url('/assets/main-homepage-bg.png')] bg-center bg-cover bg-no-repeat">
