function Gift(props) {
	return (
		<div className="min-w-fit flex items-center -mt-10 relative z-index-0 min-h-screen px-2 bg-cover bg-center bg-no-repeat bg-fixed">
			<div className="container flex flex-col box-border px-2 items-center justify-center bg-yellow-100 border-8 border-yellow-800 rounded-md w-fit md:max-w-4xl md:mx-auto h-max py-5 my-24 text-center relative z-index-1">
