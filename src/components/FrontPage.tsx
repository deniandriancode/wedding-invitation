...
interface Props {
    decGuestName: string;
    handlOpenInvite: HandleOpenInvite;
}

function FrontPage({ decGuestName, handleOpenInvite }): React.FC<Props> {
    ...
    return (
        <section className={`w-screen h-screen flex items-center justify-center bg-[url(/img/frame-edited.jpg)] bg-[url()] bg-center bg-cover bg-no-repeat ${bgColor}`}>
